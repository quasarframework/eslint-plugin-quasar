...
const qpopupproxy_breakpoint = readModuleFile('../test-files/q-popupproxy-breakpoint.txt')
const qpopupproxy_passthru = readModuleFile('../test-files/q-popupproxy-passthru.txt')

//------------------------------------------------------------------------------
// Requirements
//------------------------------------------------------------------------------

const rule = require("../../../lib/rules/no-invalid-props")
...
ruleTester.run("no-invalid-props", rule, {

  valid: [
    qpopupproxy_passthru,
    qpopupproxy_breakpoint,
